...
parser.add_argument('--save_latest_freq', dest='save_latest_freq', type=int, default=50, help='save the latest model every latest_freq sgd iterations (overwrites the previous latest model)')
